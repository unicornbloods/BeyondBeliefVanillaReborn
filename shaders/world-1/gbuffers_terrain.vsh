		...
		if (mc_Entity.x > 10000.0) {
			...
			if (id == 1) { //grass blocks and dirt
				...
				if (amt > 0.1) { //will always either be 0.0 or 1.0
					pos.xyz += windOffset(pos.xyz + cameraPosition, amt * lmcoord.y * lmcoord.y, WSPEED);
				}
		}
			...
			#ifdef WAVING_LEAVES
				pos.xyz += windOffset(pos.xyz + cameraPosition, lmcoord.y * lmcoord.y, WSPEED);
			#endif
		}
